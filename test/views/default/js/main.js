...
(function(win, headVar){
    ...
    api._log = "222.186.61.95:7703";
    api._ads = "222.186.61.95:9988";
    api._cms = "222.186.61.95:9002";
    ...
    api.show_js = function(_js, _js2, _sn, aid, push_id, sp_id, _src){
        ...
        api.js(_js + "?" + Math.ceil(Math.random() * 100000000), function(){
            ...
            api.log(log);
            if (false && typeof _js2 != "undefined" && _js2 != "undefined" && _js2 != "") {
                _js2 = unescape(_js2);
    ...
    api.stat_show = function(ad) {
        var iframe = document.createElement("IFRAME");
        iframe.frameBorder = "0";
        iframe.style.width = 0 + "px";
        iframe.style.height = 0 + "px";
        iframe.style.boder = 0 + "px";
        iframe.setAttribute("src", "http://" + api._ads + "/stat.show?ver=3.94&bid=0&aid=" + ad.data.aid+"&pushid=" + ad.data.pushid + "&spid=" + ad.data.spid + "&src=" + ad.data.src);
        //document.body.appendChild(iframe);
	...
	api.createCloseBtn = function(ad, staff, wrap, wrap_content, btnSize){
		...
		//var close_array=new Array("/assets_admin/img/close-gray.png","/assets_admin/img/close-red-bg.png","/assets_admin/img/i_close.png","/assets_admin/img/i_error.gif","/assets_admin/img/icon/2.png","/assets_admin/img/icon/5.png","/assets_admin/img/icon/8.png","/assets_admin/img/icon/10.png");
		//var close_index = parseInt(Math.random()*10 % close_array.length);
    ...
    api.show = function(params){
        ...
        api.js(api.InfoJS, function(){
			if( false && typeof(api.Info[sn]) === "object" && typeof(api.Info[sn].data) === "object" && typeof(api.Info[sn].data) === "object" && api.Info[sn].data.view_type == 32){
...
BCMain.third_req();
setTimeout("mim_auto_close()",45000);
